...
<html>
    ...
    <body>
        ...
        <?php
            $servname = "localhost"; $dbname = "saisie"; $user = "coco"; $pass = "cocorico";
            ...
            try {
                ...
                $sql = "DELETE FROM carnet_adresse WHERE nom = :nom AND prenom = :prenom AND adresse = :adresse AND cdp = :cdp AND ville = :ville AND tel = :tel";
