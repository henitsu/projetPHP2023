...
<body>
    ...
    <?php
        ...
        $reponseNbHeuresParMedecin = $bdd->query("SELECT SUM(DureeConsultationMinutes)/60, medecin.Nom FROM rdv, medecin WHERE medecin.Id_Medecin = rdv.Id_Medecin GROUP BY medecin.Id_Medecin");
